        ...
        <div className="my-16 mx-12 sm:mx-24">
            ...
            <div className="w-full flex flex-col py-2 xl:flex-row gap-8">
                <div className="flex flex-col w-full xl:w-1/2 space-y-4">
                    <div className="h-full flex justify-around xl:justify-between sm:justify-between items-center px-4 sm:px-8 bg-[#D6D6D8] text-[#212121]">
                        <div>
                    ...
                    <div className="h-full flex flex-col justify-center items-center pt-12 px-8 pb-8 bg-zinc-900 text-white">
                ...
                <div className="flex flex-1 justify-between gap-4">
                    <div className="flex w-full xl:w-1/2 flex-col justify-between pt-6 bg-[#EFE1C7]">
                        <div className="mx-4">
                    ...
                    <div className="flex w-full xl:w-1/2 flex-col justify-between pt-6 bg-[#D7D7D9]">
                        <div className="mx-4">
